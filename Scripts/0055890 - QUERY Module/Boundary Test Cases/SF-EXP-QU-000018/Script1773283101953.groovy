...
String input1000 = 'A' * 1000

WebUI.setText(findTestObject('Page_e-Konek Apps - SF Status Uploader/input_HAWB'), input1000)

String actual1000 = WebUI.getAttribute(findTestObject('Page_e-Konek Apps - SF Status Uploader/input_HAWB'), 'value')

println("Typed 1000 characters, accepted: " + actual1000.length())
